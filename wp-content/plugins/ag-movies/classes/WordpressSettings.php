...
abstract class WordpressSettings {
	...
	public function render_fields( $tab ) {
		...
		foreach ( $this->fields[ $tab ] as $name => $field ) {
		  ...
		  if ( !empty($field['force_value']) ) $field['default'] = $field['force_value'];
	...
	public function render_text( $field ){
		...
		<tr>
			...
			<td>
				<input type="<?php echo $type; ?>" class="<?php echo $class; ?>" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo $default; ?>" placeholder="<?php echo $placeholder; ?>" />
				<?php if( $desc != '' ) {
	...
	public function render_textarea( $field ){
		...
		<tr>
			...
			<td>
				<textarea name="<?php echo $name; ?>" class="<?php echo $class; ?>" id="<?php echo $name; ?>" placeholder="<?php echo $placeholder; ?>" ><?php echo $default; ?></textarea>
				<?php if( $desc != '' ) {
					echo '<p class="description">' . $desc . '</p>';
				}?>
			</td>
	...
	public function render_select( $field ) {
		...
		<tr>
			...
			<td>
				<select <?php echo isset($class) ? 'class="'.$class.'"' : ''; ?> name="<?php echo $name; ?>" id="<?php echo $name; ?>" >
					<?php
